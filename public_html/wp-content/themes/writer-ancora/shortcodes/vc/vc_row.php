...
if (function_exists('vc_map_get_attributes')) {						// New VC
	...
	// Add Writer Ancora color scheme in the row
	if ($scheme && !writer_ancora_param_is_off($scheme) && !writer_ancora_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	...
	// Add Writer Ancora color scheme in the row
	if ($scheme && !writer_ancora_param_is_off($scheme) && !writer_ancora_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
