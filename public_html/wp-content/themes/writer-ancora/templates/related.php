...
if ( !function_exists( 'writer_ancora_template_related_theme_setup' ) ) {
	add_action( 'writer_ancora_action_before_init_theme', 'writer_ancora_template_related_theme_setup', 1 );
	function writer_ancora_template_related_theme_setup() {
		writer_ancora_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'writer-ancora'),
		...
		writer_ancora_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'writer-ancora'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'writer-ancora'),
			'w'		 => 370,
			'h'		 => 370
		));
		writer_ancora_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'writer-ancora'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'writer-ancora'),
			'w'		 => 370,
			'h'		 => 370
		));
		writer_ancora_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'writer-ancora'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'writer-ancora'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'writer_ancora_template_related_output' ) ) {
	function writer_ancora_template_related_output($post_options, $post_data) {
