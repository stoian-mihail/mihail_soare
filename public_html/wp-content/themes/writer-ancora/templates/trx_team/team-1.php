...
if ( !function_exists( 'writer_ancora_template_team_1_theme_setup' ) ) {
	add_action( 'writer_ancora_action_before_init_theme', 'writer_ancora_template_team_1_theme_setup', 1 );
	function writer_ancora_template_team_1_theme_setup() {
		writer_ancora_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Team /Style 1/', 'writer-ancora'),
...
// Template output
if ( !function_exists( 'writer_ancora_template_team_1_output' ) ) {
	function writer_ancora_template_team_1_output($post_options, $post_data) {
		$show_title = true;
