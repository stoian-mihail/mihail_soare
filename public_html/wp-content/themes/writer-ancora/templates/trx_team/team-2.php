...
if ( !function_exists( 'writer_ancora_template_team_2_theme_setup' ) ) {
	add_action( 'writer_ancora_action_before_init_theme', 'writer_ancora_template_team_2_theme_setup', 1 );
	function writer_ancora_template_team_2_theme_setup() {
		writer_ancora_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_pagination sc_slider_pagination_bottom sc_slider_nocontrols',*/
			'title'  => esc_html__('Team /Style 2/', 'writer-ancora'),
...
// Template output
if ( !function_exists( 'writer_ancora_template_team_2_output' ) ) {
	function writer_ancora_template_team_2_output($post_options, $post_data) {
		$show_title = true;
