...
if ( !function_exists( 'writer_ancora_template_testimonials_1_theme_setup' ) ) {
	add_action( 'writer_ancora_action_before_init_theme', 'writer_ancora_template_testimonials_1_theme_setup', 1 );
	function writer_ancora_template_testimonials_1_theme_setup() {
		writer_ancora_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'writer-ancora'),
			'thumb_title'  => esc_html__('Avatar (small)', 'writer-ancora'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'writer_ancora_template_testimonials_1_output' ) ) {
	function writer_ancora_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
