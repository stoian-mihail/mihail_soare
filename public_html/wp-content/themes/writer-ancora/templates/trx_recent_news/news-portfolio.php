...
if ( !function_exists( 'writer_ancora_template_news_portfolio_theme_setup' ) ) {
	add_action( 'writer_ancora_action_before_init_theme', 'writer_ancora_template_news_portfolio_theme_setup', 1 );
	function writer_ancora_template_news_portfolio_theme_setup() {
		writer_ancora_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'writer-ancora'),
...
// Template output
if ( !function_exists( 'writer_ancora_template_news_portfolio_output' ) ) {
	function writer_ancora_template_news_portfolio_output($post_options, $post_data) {
